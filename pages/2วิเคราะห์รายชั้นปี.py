...
html_21="""
<div style="background-color:#2E6C92;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
...
html_22="""
<div style="background-color:#2E6C92;padding:10px;border-radius:10px 10px 10px 10px;border-style:'solid';border-color:black">
