...
html_21="""
<div style="background-color:#4A8522;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
 <center><h3>การวิเคราะห์รายโรงเรียน</h3></center>
</div>
"""
st.image('./pic/ban6.png')
...
html_22="""
<div style="background-color:#4A8522;padding:10px;border-radius:10px 10px 10px 10px;border-style:'solid';border-color:black">
