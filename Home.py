...
#First Subplot
fig.add_trace(radar_chart(5,2,7,9,4), row=1, col=1)

# col2 
fig.add_trace(radar_chart(5,2,7,9,4), row=1, col=2)

#First Subplot
fig.add_trace(radar_chart(5,2,7,9,4), row=2, col=1)

# col2 
fig.add_trace(radar_chart(5,2,7,9,4), row=2, col=2)

#First Subplot
fig.add_trace(radar_chart(5,2,7,9,4), row=3, col=1)

# col2 
fig.add_trace(radar_chart(5,2,7,9,4), row=3, col=2)
